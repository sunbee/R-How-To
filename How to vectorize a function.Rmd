...
## Output
Read the table into R. Work off the model shown.
```{r}
out <- vecGetWeather(lat=c(26.40000, 30.16667, 24.68333), 
                      long=c(90.63333, 74.16667, 72.83333), 
                      timeStamp="2015-06-29T12:00:00+0530")
```
Examine the input. It supplies three pairs of lat-long coordinates in separate lists. The lone time-stamp is the odd man out. It is recycled thrice. 
Examine the output. It is a list of three items. Each of these three items is the result of an API query with latitude, longitude and time-stamp. 
