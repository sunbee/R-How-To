# Test Suite for renderMap()
# Ref: http://www.johnmyleswhite.com/notebook/2010/08/17/unit-testing-in-r-the-bare-minimum/

# Files:
# renderMap.R                     # Containts functions for testing
# tests_renderMap                 # THIS FOLDER Contains test scripts
# 1.R                             # THIS FILE A set of tests
# runTests_renderMap.R            # Master file to run all tests
